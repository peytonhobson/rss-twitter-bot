...
export function getLLMPollParameters(article) {
    const content = `
  ...
  `;
    return {
        ...
        tools: [
            {
                        ...
                        properties: {
                            parameters: {
                                ...
                                properties: {
                                    question: {
                                        type: 'string',
                                        description: 'The poll question that is engaging and relevant to the topic.',
                                        maxLength: 100
                                    },
                                    content: {
                                        type: 'string',
                ...
                `,
                                    ...
                                    options: {
                                        ...
                                        minItems: 2,
                                        maxItems: 4,
                                        description: 'Four possible poll options that are under 25 characters each'
                                    }
                                },
        ...
        sanitize: (data) => r.required(r.object(data, ({ question, content: tweetContent, options }) => {
            return {
